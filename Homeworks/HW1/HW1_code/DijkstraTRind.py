...
def bounds(x_list):
    ...
    # TODO: Implement this section. Keep the function name and inputs unchanged, but modify the output as required.
...
def main():
    ...
    prestate = [Int("x[0]")]  # TODO: Implement this line
    # 2. create a list of z3 Int variables called poststate which is [x'[0], x'[1], x'[2],....,x'[N-1]]
    poststate = [Int("x'[0]")]  # TODO: Implement this line
